...
\autor{ Lays de Freitas Melo} % (José da Silva)
\autorR{de Freitas Melo, Lays} % (da Silva, José)

\titulo{Estudo e Definição de um Modelo de Predição de Óbitos no Contexto da COVID-19}
%\subtitulo{\textless Subtítulo do Trabalho\textgreater}

\cidade{Goiânia} % Nome da cidade em foi desenvolvido o trabalho
\dia{21} %
\mes{Agosto} % Data da apresentação/defesa do trabalho
\ano{2023} % Formato numérico: \dia{01}, \mes{01} e \ano{2009}
